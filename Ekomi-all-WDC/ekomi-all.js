(function() {
    ...
    myConnector.getData = function(table, doneCallback) {
        $.getJSON("http://localhost:8889/api.ekomi.de/v3/getFeedback?auth=94983|11f79d2e7beebdd7766a96baf&version=cust-1.0.0&type=json&charset=utf-8&range=all", function(resp) {
    ...
    $(document).ready(function() {
        $("#submitButton").click(function() {
            tableau.connectionName = "ekomi_all "; // This will be the data source name in Tableau
